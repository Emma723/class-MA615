...
year <-c(1875:1972)
# Plot the ggplot
ggplot(data = as.data.frame(LakeHuron),mapping = aes(x=year,y=LakeHuron))+geom_point()+geom_line(color="red")
# Plot with smoother
ggplot(data = as.data.frame(LakeHuron),mapping = aes(x=year,y=LakeHuron))+geom_point()+geom_line(color="blue")+geom_smooth(stat = "smooth",color="red",se=F)
```
